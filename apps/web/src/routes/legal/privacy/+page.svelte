<div class="w-full bg-base-100 shadow rounded-lg p-5">
  <h2 class=" font-medium text-base-content text-2xl opacity-50 mt-2 mb-1 ml-1">
    Privacy Policy
  </h2>

  <p>
    At rewriteIT, accessible from www.rewriteit.app, one of our main priorities
    is the privacy of our visitors. This Privacy Policy document contains types
    of information that is collected and recorded by rewriteIT and how we use
    it.
  </p>
  ...
  <p>
    ...
    and/or collect in rewriteIT. This policy is not applicable to any
    information collected offline or via channels other than this website.
  </p>

  <h2 class=" font-medium text-base-content text-xl opacity-50 mt-2 mb-1 ml-1">
    Consent
  </h2>
  ...
  <p>
    rewriteIT follows a standard procedure of using log files. These files log
  ...
  <p>
    Like any other website, rewriteIT uses "cookies". These cookies are used to
  ...
  <p>
    ...
    advertising partners of rewriteIT.
  </p>

  <p>
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on rewriteIT, which are sent directly to users'
  ...
  <p>
    Note that rewriteIT has no access to or control over these cookies that are
  ...
  <p>
    rewriteIT's Privacy Policy does not apply to other advertisers or websites.
  ...
  <p>
    rewriteIT does not knowingly collect any Personal Identifiable Information
